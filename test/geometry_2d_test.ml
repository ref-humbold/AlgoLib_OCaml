...
let sort_by_x__then_sorted_stably_ascending =
  ...
  >:: fun _ ->
    (* given *)
    let sequence =
      [ pt2d_i 0 0; pt2d_i (-2) (-3); pt2d_i (-3) 2; pt2d_i 2 3; pt2d_i 3 (-2); pt2d_i (-2) 3;
        pt2d_i 3 2; pt2d_i 2 (-3); pt2d_i (-3) (-2) ]
    in
    (* when *)
    ...
    assert_equal
      ...
      [ pt2d_i (-3) 2; pt2d_i (-3) (-2); pt2d_i (-2) (-3); pt2d_i (-2) 3; pt2d_i 0 0; pt2d_i 2 3;
        pt2d_i 2 (-3); pt2d_i 3 (-2); pt2d_i 3 2 ]
      result
...
let sort_by_y__then_sorted_stably_ascending =
  ...
  >:: fun _ ->
    ...
    assert_equal
      ~printer:(Printers.list print_point)
      [ pt2d_i (-2) (-3); pt2d_i 2 (-3); pt2d_i 3 (-2); pt2d_i (-3) (-2); pt2d_i 0 0; pt2d_i (-3) 2;
        pt2d_i 3 2; pt2d_i 2 3; pt2d_i (-2) 3 ]
      result
...
let sort_by_angle__then_sorted_ascending =
  ...
  >:: fun _ ->
    ...
    assert_equal
      ~printer:(Printers.list print_point)
      [ pt2d_i 0 0; pt2d_i 3 2; pt2d_i 2 3; pt2d_i (-2) 3; pt2d_i (-3) 2; pt2d_i (-3) (-2);
        pt2d_i (-2) (-3); pt2d_i 2 (-3); pt2d_i 3 (-2) ]
      result
