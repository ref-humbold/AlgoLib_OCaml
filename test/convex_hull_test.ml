...
let find_convex_hull__then_points_in_hull =
  ...
  >:: fun _ ->
    ...
    let result =
      find_convex_hull
        [ Point_2d.pt2d_i 1 (-3); Point_2d.pt2d_i (-4) 6; Point_2d.pt2d_i (-5) (-7);
          Point_2d.pt2d_i (-8) (-7); Point_2d.pt2d_i (-3) (-4); Point_2d.pt2d_i 5 9;
          Point_2d.pt2d_i (-1) (-8); Point_2d.pt2d_i (-5) 10; Point_2d.pt2d_i 8 0;
          Point_2d.pt2d_i 3 (-6); Point_2d.pt2d_i (-2) 1; Point_2d.pt2d_i (-2) 8;
          Point_2d.pt2d_i 10 2; Point_2d.pt2d_i 6 3; Point_2d.pt2d_i (-7) 7; Point_2d.pt2d_i 6 (-4) ]
    in
    (* then *)
    assert_equal
      ~printer:(Printers.list print_point)
      [ Point_2d.pt2d_i (-8) (-7); Point_2d.pt2d_i (-1) (-8); Point_2d.pt2d_i 3 (-6);
        Point_2d.pt2d_i 6 (-4); Point_2d.pt2d_i 10 2; Point_2d.pt2d_i 5 9; Point_2d.pt2d_i (-5) 10;
        Point_2d.pt2d_i (-7) 7 ]
      result
...
let find_convex_hull__when_multiple_points_are_collinear__then_inner_points_omitted =
  ...
  >:: fun _ ->
    ...
    let result =
      find_convex_hull
        [ Point_2d.pt2d_i (-1) (-3); Point_2d.pt2d_i (-3) (-3); Point_2d.pt2d_i (-3) (-1);
          Point_2d.pt2d_i 2 (-3); Point_2d.pt2d_i (-3) 5; Point_2d.pt2d_i 0 (-3);
          Point_2d.pt2d_i 7 (-3); Point_2d.pt2d_i (-3) (-2) ]
    in
    (* then *)
    assert_equal
      ~printer:(Printers.list print_point)
      [Point_2d.pt2d_i (-3) (-3); Point_2d.pt2d_i 7 (-3); Point_2d.pt2d_i (-3) 5]
      result
