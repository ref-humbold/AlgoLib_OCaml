...
let count_lcs_length__when_empty__then_zero =
  "count_lcs_length When empty Then zero" >:: fun _ ->
    (* when *)
...
let count_lcs_length__when_repeated_single_element__then_one =
  "count_lcs_length When repeated single element Then one" >:: fun _ ->
    (* when *)
...
let count_lcs_length__when_same_text__then_text_length =
  "count_lcs_length When same text Then text length" >:: fun _ ->
    (* given *)
...
let count_lcs_length__when_subtext__then_subtext_length =
  "count_lcs_length When subtext Then subtext length" >:: fun _ ->
    (* when *)
...
let count_lcs_length__when_different__then_zero =
  "count_lcs_length When different Then zero" >:: fun _ ->
    (* when *)
...
let count_lcs_length__when_common_subtext__then_common_subtext_length =
  "count_lcs_length When common subtext Then common subtext length" >:: fun _ ->
    (* when *)
