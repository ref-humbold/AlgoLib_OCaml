...
let sort_by_x__then_sorted_stably_ascending =
  ...
  >:: fun _ ->
    (* given *)
    let sequence =
      [ pt3d_i 0 0 0; pt3d_i 2 3 (-5); pt3d_i (-2) (-3) 5; pt3d_i 2 (-3) (-5); pt3d_i (-2) (-3) (-5);
        pt3d_i 3 2 5; pt3d_i (-3) 2 5 ]
    in
    (* when *)
    ...
    assert_equal
      ...
      [ pt3d_i (-3) 2 5; pt3d_i (-2) (-3) 5; pt3d_i (-2) (-3) (-5); pt3d_i 0 0 0; pt3d_i 2 3 (-5);
        pt3d_i 2 (-3) (-5); pt3d_i 3 2 5 ]
      result
...
let sort_by_y__then_sorted_stably_ascending =
  ...
  >:: fun _ ->
    ...
    assert_equal
      ~printer:(Printers.list print_point)
      [ pt3d_i (-2) (-3) 5; pt3d_i 2 (-3) (-5); pt3d_i (-2) (-3) (-5); pt3d_i 0 0 0; pt3d_i 3 2 5;
        pt3d_i (-3) 2 5; pt3d_i 2 3 (-5) ]
      result
...
let sort_by_z__then_sorted_stably_ascending =
  ...
  >:: fun _ ->
    ...
    assert_equal
      ~printer:(Printers.list print_point)
      [ pt3d_i 2 3 (-5); pt3d_i 2 (-3) (-5); pt3d_i (-2) (-3) (-5); pt3d_i 0 0 0; pt3d_i (-2) (-3) 5;
        pt3d_i 3 2 5; pt3d_i (-3) 2 5 ]
      result
