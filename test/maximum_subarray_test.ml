...
let maximum_subarray__when_all_elements_are_positive__then_whole_sequence =
  "maximum_subarray When all elements are positive Then whole sequence" >:: fun _ ->
    (* given *)
...
let maximum_subarray__when_negative_less_than_subsum__then_include_negative =
  "maximum_subarray When negative less than subsum Then include negative" >:: fun _ ->
    (* when *)
...
let maximum_subarray__when_negative_greater_than_subsum__then_exclude_negative =
  "maximum_subarray When negative greater than subsum Then exclude negative" >:: fun _ ->
    (* when *)
...
let maximum_subarray__when_all_elements_are_negative__then_empty =
  "maximum_subarray When all elements are negative Then empty" >:: fun _ ->
    (* when *)
...
let maximum_subarray_i__when_negative_less_than_subsum__then_include_negative =
  "maximum_subarray_i When negative less than subsum Then include negative" >:: fun _ ->
    (* when *)
...
let maximum_subarray_i__when_negative_greater_than_subsum__then_exclude_negative =
  "maximum_subarray_i When negative greater than subsum Then exclude negative" >:: fun _ ->
    (* when *)
